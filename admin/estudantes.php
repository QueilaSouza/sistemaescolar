...
$sql_2 = "INSERT INTO estudantes (code, status, nome, cpf, rg, nascimento, mae, pai, cidade, bairro, telefone, ) VALUES ('$code', 'Ativo', '$nome', '$cpf', '$rg', '$nascimento', '$mae', '$pai', '$cidade', '$bairro', '$telefone')";
...
<form name="form1" method="post" action="">
  <table width="900" border="0">
    ...
    <tr>
      <td>Telefone l:</td>
      <td><input type="text" name="telefone" id="textfield11"></td>
    </tr>
    <tr>
...
$sql_3 = "UPDATE estudantes WHERE code = '$code'";
